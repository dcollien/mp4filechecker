(function (global, factory) {
	...
	(global = global || self, factory(global.mp4filechecker = {}));
	...
	*/
	...
	var mp4box_all_2 = mp4box_all.MP4BoxStream;
	var mp4box_all_3 = mp4box_all.DataStream;
	var mp4box_all_4 = mp4box_all.MultiBufferStream;
	var mp4box_all_5 = mp4box_all.MPEG4DescriptorParser;
	var mp4box_all_6 = mp4box_all.BoxParser;
	var mp4box_all_7 = mp4box_all.XMLSubtitlein4Parser;
	var mp4box_all_8 = mp4box_all.Textin4Parser;
	var mp4box_all_9 = mp4box_all.ISOFile;
	var mp4box_all_10 = mp4box_all.createFile;
	...
	var __await = (window && window.__await) || function (v) { return this instanceof __await ? (this.v = v, this) : new __await(v); };
	var __asyncGenerator = (window && window.__asyncGenerator) || function (thisArg, _arguments, generator) {
	 ...
	 */
	const checkMp4File = (file, options = DEFAULT_OPTIONS) => __awaiter(void 0, void 0, void 0, function* () {
	    var e_1, _a;
	    if (!file || !matchesOne(file.type, options.supportedMimeTypes)) {
	        return false;
	    }
	    const box = mp4box_all_10();
	    let result = null;
	    box.onReady = info => {
	        result = info;
	    };
	...
	exports.checkMp4File = checkMp4File;
